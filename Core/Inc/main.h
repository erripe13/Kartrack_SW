...
#define LORA_DI4_GPIO_Port GPIOB
#define SWO_Pin GPIO_PIN_3
#define SWO_GPIO_Port GPIOB
#define SPDIF_RX0_Pin GPIO_PIN_7
#define SPDIF_RX0_GPIO_Port GPIOD
#define LORA_DI2_Pin GPIO_PIN_15
#define LORA_DI2_GPIO_Port GPIOA
...
#define LORA_DI0_Pin GPIO_PIN_3
#define LORA_DI0_GPIO_Port GPIOI
#define LORA_DI1_Pin GPIO_PIN_2
#define LORA_DI1_GPIO_Port GPIOI
...
#define LORA_DI3_Pin GPIO_PIN_8
#define LORA_DI3_GPIO_Port GPIOA
...
#define GYRO_IT1_Pin GPIO_PIN_7
#define GYRO_IT1_GPIO_Port GPIOG
#define GPS_STDBY_Pin GPIO_PIN_6
#define GPS_STDBY_GPIO_Port GPIOG
#define BAT_LEVEL_Pin GPIO_PIN_7
#define BAT_LEVEL_GPIO_Port GPIOF
#define GYRO_IT2_Pin GPIO_PIN_6
#define GYRO_IT2_GPIO_Port GPIOF
